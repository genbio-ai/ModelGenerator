...
GB.ModelGenerator `tasks` enable rapid prototyping and experimentation through hot-swappable `backbone` and `adapter` components, which make use of standard interfaces.
