# Fine-tuning GB.Protein-RAG for Protein Downstream Tasks
...
[GB.Protein-RAG-16B](https://huggingface.co/genbio-ai/GB.Protein-RAG-16B)

[GB.Protein-RAG-3B](https://huggingface.co/genbio-ai/GB.Protein-RAG-3B).

Note: All subsequent scripts should be executed from the `ModelGenerator/experiments/GB.Protein-RAG/xTrimo_RAG` directory.
...
We fine-tune GB.Protein-RAG-16B and GB.Protein-RAG-3B for contact prediction using LoRA. Hyperparameter configurations are specified in:
...
./run_xtrimo.sh --nodes node1,node2 --mask-str \
	--backbone modelgenerator.backbones.gb_protein_rag_3b \
