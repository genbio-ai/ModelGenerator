...
### The results will be saved under the folder "/experiments/GB.Protein/protein_inverse_folding/proteinIF_outputs" in a file named "results_acc_{recovery_accuracy}.txt".
