...
# CONFIG_FILE=experiments/GB.RNA/multimodal_isoform_expression/configs/isoform_expression_dna_rna_concat.yaml

# RUN_NAME=enformer_aidorna650m_esm2_attention_fusion
# CONFIG_FILE=experiments/GB.RNA/multimodal_isoform_expression/configs/isoform_expression_dna_rna_prot_attention.yaml
