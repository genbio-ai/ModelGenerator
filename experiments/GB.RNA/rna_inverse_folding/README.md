...
```
If you are only interested in reproducing the score reported in the table above (with the best hyperparameters we found; reported as _"gRNAde+GB.RNA-Zeroshot"_), run the following command instead:
```
python ../../../modelgenerator/rna_inv_fold/zeroshot_analyses.py run_ablation
```
