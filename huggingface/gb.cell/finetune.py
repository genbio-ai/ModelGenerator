#!/usr/bin/env python3
"""
GB.Cell Fine-tuning Script

This script demonstrates how to fine-tune GB.Cell with a linear classification head.
...
from gb_cell.utils import preprocess_counts
...
NUM_GENES = 19264                        # GB.Cell gene count
...
print("\n" + "="*60)
print("GB.Cell Fine-tuning Example")
print("="*60)
