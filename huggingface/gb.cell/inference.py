#!/usr/bin/env python3
"""
GB.Cell Gene Expression Reconstruction Script

This script uses the pretrained decoder head from GB.Cell to reconstruct
...
# Print configuration
print("\n" + "="*60)
print("GB.Cell Gene Expression Reconstruction")
print("="*60)
...
# Align data to GB.Cell gene set
