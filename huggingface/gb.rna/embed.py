#!/usr/bin/env python3
"""
GB.RNA Embedding Script

This script loads pre-trained GB.RNA models from HuggingFace and generates embeddings.
...
from gb_rna import RNABertModel, RNABertTokenizer, validate_sequences, get_vocab_filepath
import gb_rna
...
def main():
    print(f"GB.RNA Embedding Script")
    print(f"=" * 60)
