#!/usr/bin/env python3
"""
GB.RNA Fine-tuning Script

This script demonstrates how to fine-tune GB.RNA with a linear classification head.
...
# Import from gb_rna package
from gb_rna import RNABertModel, RNABertTokenizer
from gb_rna.utils import get_vocab_filepath
import gb_rna
...
LEARNING_RATE = 1e-4
NUM_EPOCHS = 5
FREEZE_BACKBONE = False                  # Set True to freeze GB.RNA weights (ignored if USE_LORA=True)
...
def main():
    print(f"GB.RNA Fine-tuning Script")
    print(f"=" * 60)
