#!/usr/bin/env python3
"""
GB.RNA Inference/Generation Script

This script uses the pretrained decoder head from GB.RNA to reconstruct
...
from gb_rna import RNABertForMaskedLM, RNABertTokenizer
...
def main():
    print(f"GB.RNA Inference Script")
    print(f"=" * 60)
